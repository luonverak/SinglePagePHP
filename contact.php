<!-- Page Header-->
<header id="contact-block" class="masthead" style="background-image: url('assets/img/contact-bg.jpg')">
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    <form method="post" enctype="multipart/form-data" id="contactForm"
                        ...
                        <div class="form-floating">
                            <input class="form-control" name="files" id="files" type="file"
                                placeholder="Enter your choose file..." data-sb-validations="required" />
                        ...
                        <button name="btnSend" class="btn btn-primary text-uppercase " id="submitButton"
...
function submitData()
{
    if (isset($_POST['btnSend'])) {
        ...
        $files = rand(1, 100000) . '-' . $_FILES['files']['name'];
        move_uploaded_file($_FILES['files']['tmp_name'], 'assets/img/' . $files);
    }
}
submitData();
?>